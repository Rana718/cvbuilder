                            ...
                            >
                                <div className="flex items-start space-x-4 mb-6">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600 text-lg leading-relaxed mb-6">
                                            Ai-rezume builder is an online platform that provides AI-powered resume creation tools, 
                            ...
                            >
                                <div className="flex items-start space-x-4 mb-6">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600 text-lg leading-relaxed">
                                            Ai-rezume builder and its content are protected by intellectual property laws. 
